...
/* $Id: testlib.c,v 1.3 2009/06/10 21:28:24 glk Exp $ */
...

{
 ...
 int32_t year_out, month_out, day_out, hour_out, minute_out, second_out;

 int32_t Doy,Doy_out,JulianDate,JulianDate_out;

 int32_t leap_sec,gps_week,gps_week_out;

 unsigned int     gps_minutes,gps_minutes_out;

 uint16_t gps_millisecs,gps_millisecs_out;

 int16_t option_code;

 int8_t cal_str[MAXCHAR],cal_str_out[MAXCHAR];
